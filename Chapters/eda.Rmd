...
The evaluation metrics for the naive model are provided in __Table 5__. Some of these metrics will be used to evaluate the models that are built, so it is worth discussing them here to ensure they are well understood.
