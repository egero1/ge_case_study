...
Unfortunately, Naive Bayes did not perform as well as expected, as seen in __Table 15__. The trimmed data set from the 'rfe' method provides the best accuracy at `r round(nb.cm.md$overall[1] * 100, 2)`%. The confusion matrix for this model is provided in __Table 16__ and the ROC plot is available in __Figure 13__. 
