...
decisionplot(model = impVars, data1 = model_data['Hist_2_150_2_Entropy'], data2 = model_data['Hist_2_30_2_Entropy'], class = "Label", main = "SVM: Important Variables", predict_type = "raw")
