...
The confusion matrix for this model is available in __Table 12__. The model detects Pneumoconiosis in 83 patients when no disease is actually present, and fails to detect the presence of Pneumoconiosis in 129 patients. 
...
The AUC in __Figure 10__ of `r svm.auc` is a slight improvement over the best GLM model.  
